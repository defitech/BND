...
Defitech.App = Ext.extend(Ext.Viewport, {
    ...
    login: function() {
        var win = new Ext.Window({
            ...
            resizable: false,
            layout: 'fit',
            title: Defitech.wording.connect_title,
            items: {
                xtype: 'form',
                border: false,
                ...
                items: [{
                    xtype: 'textfield',
                    fieldLabel: Defitech.wording.connect_login,
                    name: 'login'
                },{
                    xtype: 'textfield',
                    fieldLabel: Defitech.wording.connect_password,
                    name: 'pass',
                    inputType: 'password',
                ...
                bbar: ['->', {
                    text: Defitech.wording.connect_title,
                    scale: 'medium',
    ...
    initComponent: function() {
        Ext.apply(this, {
            ...
            items: [{
                region: 'center',
                iconCls: 'book-main',
                title: Defitech.wording.library_title,
                layout: 'fit',
                margins: '50',
                items: [{
                ...
                tbar: this.initActionButtons().concat([
                    {
                        text: Defitech.wording.info_book_button,
                        iconCls: 'book-info',
                        scale: 'medium',
                        ref: '../../bookinfo',
                        disabled: true,
        ...
        Defitech.App.superclass.initComponent.apply(this, arguments);
    }
